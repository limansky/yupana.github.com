...
Yupana позволяет собрать и обработать данные различных ОФД в едином формате и методологии, соблюдя все основные 
принципы безопасности, конфиденциальности и сохранности сведений клиентов, подключенных к оператору. 
